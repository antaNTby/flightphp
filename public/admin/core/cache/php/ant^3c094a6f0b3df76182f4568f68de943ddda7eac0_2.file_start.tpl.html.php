<?php
/* Smarty version 5.1.0, created on 2024-06-12 09:15:24
  from 'file:start.tpl.html' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.1.0',
  'unifunc' => 'content_66693cfcdbb9d8_46404568',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3c094a6f0b3df76182f4568f68de943ddda7eac0' => 
    array (
      0 => 'start.tpl.html',
      1 => 1715934266,
      2 => 'file',
...
function content_66693cfcdbb9d8_46404568 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'W:\\domains\\antCMS.os\\admin\\tpl';
?><h1 class="display-5 text-xl-center">Welcome, <span class="badge text-bg-secondary"> <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('adminlogname')), ENT_QUOTES, 'UTF-8');?>
 ! </span></h1>
...
?>
                ...
                <li class="list-group-item bg-danger" aria-current="true"><a class="card-link text-white text-start text-xl-center text-decoration-none" href="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('mySubMenu')[($_smarty_tpl->getValue('__smarty_section_sub_index')['index'] ?? null)]['sub_href']), ENT_QUOTES, 'UTF-8');?>
" role="button"><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('mySubMenu')[($_smarty_tpl->getValue('__smarty_section_sub_index')['index'] ?? null)]['name']), ENT_QUOTES, 'UTF-8');?>
 <sub class="ps-2 fw-lighter text-dark text-opacity-25 text-decoration-none"><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('mySubMenu')[($_smarty_tpl->getValue('__smarty_section_sub_index')['index'] ?? null)]['id']), ENT_QUOTES, 'UTF-8');?>
</sub></a></li>
                <?php } else { ?>
                <li class="list-group-item"><a class="card-link text-dark text-start text-xl-center text-decoration-none" href="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('mySubMenu')[($_smarty_tpl->getValue('__smarty_section_sub_index')['index'] ?? null)]['sub_href']), ENT_QUOTES, 'UTF-8');?>
" role="button"><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('mySubMenu')[($_smarty_tpl->getValue('__smarty_section_sub_index')['index'] ?? null)]['name']), ENT_QUOTES, 'UTF-8');?>
 <sub class="ps-2 fw-lighter text-dark text-opacity-25 text-decoration-none"><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('mySubMenu')[($_smarty_tpl->getValue('__smarty_section_sub_index')['index'] ?? null)]['id']), ENT_QUOTES, 'UTF-8');?>
</sub></a></li>
                <?php }?>
